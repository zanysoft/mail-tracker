...
use ZanySoft\MailTracker\MailTracker;
...
use ZanySoft\MailTracker\Exceptions\BadUrlLink;
...
use ZanySoft\MailTracker\Events\ComplaintMessageEvent;
...
class MailTrackerTest extends SetUpTest
{
    ...
    {
        $url = action('\ZanySoft\MailTracker\SNSController@callback');
    ...
    public function it_processes_a_delivery()
    {
        ...
        $response = $this->post(action('\ZanySoft\MailTracker\SNSController@callback'), [
                'message' => json_encode([
